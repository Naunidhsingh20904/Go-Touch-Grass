...
val Typography = Typography(
    // ============ DISPLAY ============
    // Used for: Level numbers, large XP displays, hero stats
    ...
    // ============ HEADLINES ============
    // Used for: Screen titles, section headers, zone names
    ...
    // ============ TITLES ============
    // Used for: Card titles, list item headers, badge names
    ...
    // ============ BODY ============
    // Used for: Descriptions, zone info, challenge details
    bodyLarge = TextStyle(
        fontFamily = AppFontFamily,
