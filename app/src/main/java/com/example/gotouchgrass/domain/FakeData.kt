...
/**
 * Centralized in-memory fake data set that models
 * the full Go Touch Grass domain.
 *
 * This is meant for prototyping screens and flows
 * before a real backend exists.
 */
object FakeData {
    ...
    val cities: List<City> = listOf(
        City(
            ...
            timezone = "America/Toronto",
            boundingBox = listOf(
                LatLng(43.5000, -80.6000),
                LatLng(43.5000, -80.4500),
                LatLng(43.4200, -80.4500),
                LatLng(43.4200, -80.6000)
            )
        )
    )
    ...
    val zones: List<Zone> = listOf(
        Zone(
            ...
            type = ZoneType.CAMPUS,
            boundary = listOf(
                LatLng(43.4720, -80.5450),
                LatLng(43.4720, -80.5350),
                LatLng(43.4680, -80.5350),
                LatLng(43.4680, -80.5450)
            ),
            centerLatLng = LatLng(43.4700, -80.5400)
        ),
        Zone(
            id = "zone_hidden_garden",
            cityId = "city_waterloo",
            name = "Hidden Garden",
            type = ZoneType.PARK,
            boundary = listOf(
                LatLng(43.4710, -80.5420),
                LatLng(43.4710, -80.5405),
                LatLng(43.4695, -80.5405),
                LatLng(43.4695, -80.5420)
            ),
            centerLatLng = LatLng(43.4702, -80.5412)
        )
    )
    ...
    val landmarks: List<Landmark> = listOf(
        Landmark(
            id = "lm_campus_mural",
            zoneId = "zone_campus_core",
            name = "Library Mural",
            category = LandmarkCategory.MURAL,
            latLng = LatLng(43.4705, -80.5390),
            radiusMeters = 25.0,
            description = "Colorful student-painted mural behind the main library.",
            photoRef = null,
            createdByUserId = "user_you",
            isVerified = true
        ),
        Landmark(
            id = "lm_hidden_garden_bench",
            zoneId = "zone_hidden_garden",
            name = "Secret Study Bench",
            category = LandmarkCategory.STUDY_SPOT,
            latLng = LatLng(43.4703, -80.5410),
            radiusMeters = 15.0,
            description = "Quiet bench surrounded by trees and fairy lights.",
            photoRef = null,
            createdByUserId = null,
            isVerified = false
        )
    ...
    val visitSessions: List<VisitSession> = listOf(
        VisitSession(
            ...
            zoneId = "zone_hidden_garden",
            startedAtIso = "2025-10-01T14:00:00Z",
            endedAtIso = "2025-10-01T16:00:00Z",
            durationSec = 2 * 60 * 60,
    ...
    val locationPings: List<LocationPing> = listOf(
        LocationPing(
            ...
            userId = "user_you",
            timestampIso = "2025-10-01T14:05:00Z",
            approxLatLng = LatLng(43.4702, -80.5410),
            accuracyMeters = 10.0,
            speedMetersPerSecond = 0.2,
            source = LocationSource.GPS,
            hashCell = GeoCell("dpz83m")
        )
    )
    ...
    val zoneEntryEvents: List<ZoneEntryEvent> = listOf(
        ...
        ZoneEntryEvent(
            ...
            zoneId = "zone_hidden_garden",
            type = ZoneEntryEventType.EXIT,
            timestampIso = "2025-10-01T16:00:00Z"
        )
    )
    ...
    val captures: List<Capture> = listOf(
        Capture(
            ...
            userId = "user_you",
            zoneId = "zone_hidden_garden",
            landmarkId = "lm_hidden_garden_bench",
            capturedAtIso = "2025-10-01T14:10:00Z",
            proofType = CaptureProofType.GEOFENCE,
            rarityAtTime = RarityScore(0.85),
            xpAwarded = 150,
        ...
        Capture(
            ...
            userId = "user_you",
            zoneId = "zone_campus_core",
            landmarkId = "lm_campus_mural",
            capturedAtIso = "2025-10-02T22:15:00Z",
            proofType = CaptureProofType.QR,
            rarityAtTime = RarityScore(0.40),
            xpAwarded = 75,
            coinsAwarded = 10
    ...
    val xpEvents: List<XPEvent> = listOf(
        XPEvent(
            ...
            type = XPEventType.VISIT_TIME,
            amount = 80,
            createdAtIso = "2025-10-01T16:00:00Z",
            refId = "vs_morning_study"
        ),
        XPEvent(
            id = "xp_2",
            userId = "user_you",
    ...
    val badges: List<Badge> = listOf(
        Badge(
            ...
            name = "First Capture",
            description = "Capture any landmark.",
            icon = "ic_badge_first_capture",
            ruleType = BadgeRuleType.SIMPLE_THRESHOLD,
            ruleConfigJson = """{"type":"CAPTURE_COUNT","threshold":1}"""
        ),
        Badge(
            id = "badge_study_sage",
            name = "Study Sage",
            description = "Spend 10 hours in study sessions.",
            icon = "ic_badge_study_sage",
            ruleType = BadgeRuleType.STREAK,
            ruleConfigJson = """{"type":"STUDY_HOURS","thresholdHours":10}"""
        )
    )
    ...
    val milestoneProgress: List<MilestoneProgress> = listOf(
        MilestoneProgress(
            userId = "user_you",
            milestoneId = "milestone_unique_zones_10",
            progressValue = 4.0,
            lastUpdatedAtIso = "2025-10-02T23:00:00Z"
        )
    )
    ...
    val challenges: List<Challenge> = listOf(
        Challenge(
            id = "challenge_daily_new_zone",
            title = "Visit a New Zone",
            description = "Venture out and discover a place you've never been.",
            timeWindow = ChallengeTimeWindow.DAILY,
            ruleConfigJson = """{"uniqueZones":1}""",
            rewardXP = 100,
            rewardCoins = 10
        ),
        Challenge(
            id = "challenge_weekly_zone_collector",
            title = "Zone Collector",
            description = "Visit 10 different zones this week.",
            timeWindow = ChallengeTimeWindow.WEEKLY,
            ruleConfigJson = """{"uniqueZones":10}""",
            rewardXP = 500,
            rewardCoins = 50
        )
    )
    ...
    val challengeProgress: List<ChallengeProgress> = listOf(
        ChallengeProgress(
            userId = "user_you",
            challengeId = "challenge_daily_new_zone",
            periodStartIso = "2025-10-02T00:00:00Z",
            progressValue = 0.0,
            completedAtIso = null
        ),
        ChallengeProgress(
            userId = "user_you",
            challengeId = "challenge_weekly_zone_collector",
            periodStartIso = "2025-09-29T00:00:00Z",
            progressValue = 4.0,
            completedAtIso = null
        )
    ...
    val routeStops: List<RouteStop> = listOf(
        RouteStop(
            id = "rs_1",
            routeId = "route_coffee_trail",
            orderIndex = 1,
            zoneId = "zone_campus_core",
            landmarkId = "lm_campus_mural",
            hintText = "Start at the mural behind the library."
        ),
        RouteStop(
            id = "rs_2",
            routeId = "route_nature_walk",
            orderIndex = 1,
            zoneId = "zone_hidden_garden",
            landmarkId = "lm_hidden_garden_bench",
            hintText = "Find the hidden bench under the trees."
        )
    )
    ...
    val leaderboards: List<Leaderboard> = listOf(
        Leaderboard(
            id = "lb_city_weekly_xp",
            scope = LeaderboardScope.CITY,
            metric = LeaderboardMetric.XP_WEEK,
            period = LeaderboardPeriod.WEEKLY
        ),
        Leaderboard(
            id = "lb_global_zones_captured",
    ...
    val leaderboardEntries: List<LeaderboardEntry> = listOf(
        LeaderboardEntry(
            leaderboardId = "lb_city_weekly_xp",
            userId = "user_world_explorer",
            rank = 1,
            value = 125000.0,
            computedAtIso = "2025-10-02T23:00:00Z"
    ...
    val zoneActivity: List<ZoneActivity> = listOf(
        ZoneActivity(
            ...
            userId = "user_you",
            createdAtIso = "2025-10-01T14:10:00Z",
            summaryText = "You captured Secret Study Bench"
        ),
        ZoneActivity(
            id = "za_2",
            zoneId = "zone_campus_core",
            type = ZoneActivityType.VISIT,
            userId = "user_world_explorer",
            createdAtIso = "2025-10-02T18:30:00Z",
            summaryText = "WorldExplorer is exploring Campus Core"
        )
    )
    ...
    val zonePlaylists: List<ZonePlaylist> = listOf(
        ZonePlaylist(
            id = "zp_hidden_garden_chill",
            zoneId = "zone_hidden_garden",
            provider = PlaylistProvider.SPOTIFY,
            playlistUrl = "https://open.spotify.com/playlist/hidden-garden-chill",
            title = "Hidden Garden Chill",
            createdByUserId = "user_you"
        )
    )
    ...
    val explorationSummaries: List<ExplorationSummary> = listOf(
        ExplorationSummary(
            ...
            periodStartIso = "2025-09-29T00:00:00Z",
            periodEndIso = "2025-10-05T23:59:59Z",
            topZonesJson = """[{"zoneId":"zone_hidden_garden","minutes":120}]""",
            newZonesVisited = 2,
            timeByZoneJson = """{"zone_hidden_garden":120,"zone_campus_core":60}""",
            insightsText = "You spent most of your time recharging in Hidden Garden."
        )
    )
    ...
    val approxPresence: List<ApproxPresence> = listOf(
        ApproxPresence(
            userId = "user_you",
            zoneId = "zone_campus_core",
            hashCell = GeoCell("dpz83n"),
            lastUpdatedAtIso = "2025-10-02T22:45:00Z"
        ),
        ApproxPresence(
            userId = "user_world_explorer",
            zoneId = null,
            hashCell = GeoCell("dpz83k"),
            lastUpdatedAtIso = "2025-10-02T22:40:00Z"
        )
    )
}
